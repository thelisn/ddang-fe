<template>
  ...
  <div v-else id="admin-page">
    ...
    <div class="team-container">
      ...
      <div class="team-wrap spoke">
        ...
        <ul class="user-wrap">
          <li
            class="user-data"
            v-for="(user, idx) in teamData['스포크']"
            :key="idx"
            :class="!user.isAlive ? 'dead' : null"
            @click="revive(user)"
          >
      ...
      <div class="team-wrap monimo">
        ...
        <ul class="user-wrap">
          <li
            class="user-data"
            v-for="(user, idx) in teamData['모니모']"
            :key="idx"
            :class="!user.isAlive ? 'dead' : null"
            @click="revive(user)"
          >
    ...
    <div class="btn-container">
      <button class="finish-btn" @click="() => (isEnd ? restartQuiz() : finishBtn())">
        {{ isEnd ? "재시작" : "종료" }}
      </button>
    </div>
  </div>
